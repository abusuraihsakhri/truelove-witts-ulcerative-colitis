"""
Automated Pytest for truelove-witts-ulcerative-colitis Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    TruelovewittsulcerativecolitisEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = TruelovewittsulcerativecolitisEnrichmentSuite()
